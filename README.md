...
>
Some example `digits.py` files are in `/other_digits`. These fonts are drawn using Microsoft Paint. My favorites are Jokerman (fancy!) and Ravie ("I'm not a robot font").
